      ...
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        <el-collapse-item name="1" :title="i18nt('designer.setting.basicSetting')">
          <el-form-item :label="i18nt('designer.setting.formSize')">
            <el-radio-group v-model="formConfig.size" class="radio-group-custom">
              <el-radio-button v-for="item in formSizes" :value="item.value">{{ i18nt(item.label) }}</el-radio-button>
            </el-radio-group>
          </el-form-item>
      ...
      >
        ...
        <template #footer>
          <div class="dialog-footer">
            ...
            <el-button type="primary" @click="saveGlobalFunctions"> {{ i18nt("designer.hint.confirm") }}</el-button>
          </div>
        </template>
      </el-dialog>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      formSizes: [
        { label: "designer.setting.formSizeDefault", value: "" },
        { label: "designer.setting.formSizeLarge", value: "large" },
        { label: "designer.setting.formSizeSmall", value: "small" },
      ],
