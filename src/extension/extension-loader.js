...
export const loadExtension = function (app) {
  ...
  // ];
  // PERegister.registerCPEditor(app, "alert-effect", "alert-effect-editor", PEFactory.createRadioButtonGroupEditor("effect", "extension.setting.effect", { optionItems: effectOptions }));
